...
; Inno Setup Script Output File (.iss):   C:\Documents and Settings\Pudar\My Documents\Data\Home Stuff\Magic\Visual Basic Programs\StackView V5\StackViewScript2.iss
...
Source: c:\documents and settings\pudar\scrrun.dll; DestDir: {sys}; Flags:  regserver restartreplace sharedfile
Source: c:\documents and settings\pudar\comdlg32.ocx; DestDir: {sys}; Flags:  regserver restartreplace sharedfile
Source: c:\documents and settings\pudar\mscomctl.ocx; DestDir: {sys}; Flags:  regserver restartreplace sharedfile
Source: c:\documents and settings\pudar\richtx32.ocx; DestDir: {sys}; Flags:  regserver restartreplace sharedfile
Source: c:\documents and settings\pudar\tabctl32.ocx; DestDir: {sys}; Flags:  regserver restartreplace sharedfile
